export const HOME = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Your birth chart is where Peak begins, not where it ends. Peak creates your chart and then helps you use it: to plan your day, ask questions, understand recurring patterns, set goals and ask questions that build on your earlier conversations.",
    },
    {
      q: "How does Peak personalize my astrology?",
      a: "Peak brings together your birth chart, current location, planetary timing, questions, conversation history and goals. That context helps it understand not only what is happening astrologically, but what you are trying to do with it.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. Peak can use your earlier conversations and the goals you have entered to make later guidance more relevant. You do not have to explain your life again every time you return. Your chart stays the same, but the conversation can keep moving with you.",
    },
    {
      q: "Does Peak tell me what to do?",
      a: "No. Peak can show you the timing, the pattern, the trade-offs and the possibilities around a decision. It may also point out when your choices contradict a goal you have set. But the decision remains yours.",
    },
    {
    ...
    },
    {
      ...
      a: "Peak can help you explore timing, pressure, patterns and personal priorities around serious decisions. It does not replace a doctor, lawyer or financial adviser, and it will not tell you to buy a particular stock, choose a medical treatment or take a specific legal action. Where professional expertise is needed, Peak will say so.",
    },
    {
      q: "What information do I need to create my chart?",
      a: "You will need your date, time and place of birth, along with your current location. These details allow Peak to calculate the planetary positions and houses in your birth chart. The more accurate your birth information, the more precise the chart can be.",
    },
    {
      q: "Can I use Peak if I do not know my exact birth time?",
      a: "Peak works best with an accurate birth time because it can change your rising sign, houses and timing. If you do not know it, some chart information may still be available, but the guidance may be less precise. Peak will not pretend that an uncertain chart offers the same level of detail.",
    },
    {
