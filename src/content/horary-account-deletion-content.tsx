...
/** PeakLife Horary account deletion (peaklifehorary.me). Separate from Peak / peaklife.me. */
export function HoraryAccountDeletionContent() {
  return (
    <>
      <LegalSection title="Request account deletion">
        <p>
          You can ask us to delete your PeakLife Horary account and the personal data associated
          with it. To submit a request, email us at{" "}
          <a
          ...
          from a reachable email address and include the phone number linked to your PeakLife Horary
          account.
        </p>
      </LegalSection>
      ...
      <LegalSection title="What to include in your email">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>The phone number linked to your PeakLife Horary account</li>
